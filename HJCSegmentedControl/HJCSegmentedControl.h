...
@class HJCSegmentedControl;
@protocol HJCSegmentedControlDelegate<NSObject>
@optional
-(void)segmentAction:(HJCSegmentedControl *)Seg;
@end
@interface HJCSegmentedControl : UIControl
{
    __weak id<HJCSegmentedControlDelegate>_delegate;
    
}
@property(nonatomic,weak)__weak id<HJCSegmentedControlDelegate>delegate;
...
/**
 If YES, can slide to switch page.The default value is NO.
 */
@property (nonatomic) BOOL enableSlide;
